...
Completes in ~480ms on a dual socket Skylake-X server (32 cores, 2.1GHz/core, turbo disabled, works
out to be ~32 cycles/row), with ~124 GiB DDR4 spread across two NUMA nodes. This beats the [fastest](https://github.com/lehuyduc/1brc-simd/blob/main/main.cpp)
